...
private:
    ...
    void cleanup() {
        ...
        vkDestroyCommandPool(m_device, m_drawCommandPool, nullptr);
    ...
    void createInstance() {
        ...
        auto extensions = getRequiredExensions();
    ...
    void createCommandPools() {
        ...
        if (vkCreateCommandPool(m_device, &poolInfo, nullptr, &m_drawCommandPool) != VK_SUCCESS) {
            throw std::runtime_error("Failed to create drawing command pool");
        }
    ...
    void createIndexBuffer() {
        ...
        void* data;
        vkMapMemory(m_device, staginBufferMemory, 0, bufferSize, 0, &data);
			memcpy(data, g_indices.data(), (size_t) bufferSize);
        vkUnmapMemory(m_device, staginBufferMemory);
        ...
        vkDestroyBuffer(m_device, stagingBuffer, nullptr);
        vkFreeMemory(m_device, staginBufferMemory, nullptr);
    }
    ...
    void recordCommandBuffer(VkCommandBuffer commandBuffer, uint32_t imageIndex) {
        ...
        vkCmdBeginRenderPass(commandBuffer, &renderPassInfo, VK_SUBPASS_CONTENTS_INLINE);
            ...
            vkCmdBindDescriptorSets(commandBuffer, VK_PIPELINE_BIND_POINT_GRAPHICS, m_pipelineLayout, 0, 1, &m_descriptorSets[g_currentFrame], 0, nullptr);
    ...
    void drawFrame() {
        ...
        VkResult result = vkAcquireNextImageKHR(
            ...
            m_swapchain,
            UINT64_MAX,
            m_imageAvailableSemaphores[g_currentFrame],
            VK_NULL_HANDLE,
            &imageIndex);
        ...
        updateUniformBuffer(g_currentFrame);
    ...
    bool checkExtensionSupport() {
        auto requiredExtensions = getRequiredExensions();
	...
	bool isDeviceSuitable(VkPhysicalDevice device) {
        ...
        bool extensionsSupoprted = checkDeviceExtensionSupport(device);

        bool swapchainAdequate = false;
        if (extensionsSupoprted) {
            SwapchainSupportDetails swapchainSupport = querySwapchainSupport(device);
            swapchainAdequate = swapchainSupport.isComplete();
        }

        return indices.isComplete() && extensionsSupoprted && swapchainAdequate;
    }
